package com.dikiytechies.rotp_battleroyale.network.client;
    ...
    public static void handle(HamonMultiplierCounter msg, Supplier<NetworkEvent.Context> ctx) {
        ctx.get().enqueueWork(() -> {
            ...
            if (entity instanceof LivingEntity) {
                ...
                LazyOptional<HamonUtilCap> playerDataOptional = livingEntity.getCapability(HamonUtilProvider.CAPABILITY);
